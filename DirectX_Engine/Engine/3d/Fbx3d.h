...
public:
	...
	//portalの描画
	void DrawPortalWindowBlue(ID3D12GraphicsCommandList* cmdList);
	//赤のポータル描画
	void DrawPortalWindow(int Select);
	//赤のポータル描画
	void DrawPortalWindowMove(XMFLOAT3 pos_,XMFLOAT3 rotate_,int Select);
	//fbxのアニメーション
	void PlayAnimation2();
	//setter
