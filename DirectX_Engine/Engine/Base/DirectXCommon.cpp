...
void DirectXCommon::PreDirectWriteInitialize(WinApp*winApp)
{
	//NULL検出
	assert(winApp);
...
void DirectXCommon::PostDirectWriteInitialize()
{
    //すぁっぷチェーンの初期化
    InitializeSwapchain();
    //レンダ―ターゲットビューの初期化
    InitializeRenderTargetView();
    //DirectXWriteのレンダ―ターゲットの初期化


}

void DirectXCommon::PostRenderDirectWriteInitialize()
{
...
void DirectXCommon::PostDrawPreDirectWrite()
{
    // imgui描画
    ImGui::Render();
...
void DirectXCommon::PostDrawPostDirectWrite()
{
